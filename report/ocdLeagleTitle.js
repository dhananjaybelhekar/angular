...
function fun1(callback){
 ...
 var aggregate=org1.aggregate(
  ...
  [
    ...
    {
      $match: { 
      "classificationCode":{$ne: new mongoose.Types.ObjectId("57726c33c19c305dc5b1b346")}, //master head
      "legalTitles.deleted" : {"$in" : [false, null]}
      }
    },
...
//  fs.appendFile('file3.csv', csv, function(err) {
     fs.appendFile('ocdLegalTitle.csv', csv, function(err) {
        if (err) throw err;
         console.log("done");
      });
}
